...
import { getFirestore, doc, setDoc, updateDoc, collection, getDocs, getDoc, query, where, connectFirestoreEmulator } from "firebase/firestore";
...
async function startServer() {
  ...
  // Connect to emulator (Make sure it's running if you keep this line in production/dev)
        ...
        const defaultHerbs = [
          {
            ...
            cultivation: {
              ...
              sunlight: "Sol pleno (mínimo de 6 horas por dia).",
              watering: "Regar de 2 a 3 vezes por semana, evitando encharcamento.",
              fertilization: "Adubação orgânica a cada 60 dias.",
              climate: "Clima temperado e subtropical.",
              growthTime: "60 a 90 dias para colheita.",
              harvest: "Colher os ramos antes da floração para maior concentração de óleos essenciais.",
              drying: "Secar à sombra em ambiente ventilado.",
              storage: "Armazenar em recipiente hermético, protegido da luz e umidade."
            },
            curiosities: [
